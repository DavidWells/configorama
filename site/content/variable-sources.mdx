...
The source system is fully customizable: [add your own variable sources](/guides/custom-variable-sources) when config values need to come from an internal service, secret store, deployment registry, or any project-specific lookup.
...
See [write a custom variable source](/guides/custom-variable-sources), [security model](/concepts/security-model), and [filters and functions](/filters-functions).
