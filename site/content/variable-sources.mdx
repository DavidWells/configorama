...
The source system is fully customizable: [add your own variable sources](/guides/custom-resolvers) when config values need to come from an internal service, secret store, deployment registry, or any project-specific lookup.
