...
| `errorCodes` | The full [error-code registry](/schemas/error-codes). |
...
See the [CLI reference](/cli) for the commands and [error codes](/schemas/error-codes) for the failure contract.
