...
See [debug resolution](/guides/inspect-config#debug-resolution) for the practical workflow, [filters and functions](/filters-functions) for transformations, and [variable sources](/variable-sources) for source-specific rules.
