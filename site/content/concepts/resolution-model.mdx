...
See [debug resolution](/guides/inspect-config#debug-resolution) for the practical workflow, [filters and functions](/reference/filters-functions) for transformations, and [variable sources](/reference/variable-sources) for source-specific rules.
