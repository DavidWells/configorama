...
For runtime behavior, read [the resolution model](/concepts/resolution-model). For the shared reporting model, read [the introspection model](/concepts/introspection-model) and [graph guide](/guides/dependency-graphs).
