...
Read [dependency graphs](/guides/inspect-config#dependency-graph), [requirements schema](/reference/requirements-schema), and [audit schema](/reference/audit-schema) for the concrete outputs.
