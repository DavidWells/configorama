...
For commands, read [safe inspection](/guides/inspect-config#audit-risk). For exact flags, read [security policies](/security-policies) and [error codes](/schemas/error-codes).
