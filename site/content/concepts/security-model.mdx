...
For commands, read [safe inspection](/guides/inspect-config#audit-risk). For exact flags, read [security policies](/reference/security-policies) and [error codes](/reference/error-codes).
