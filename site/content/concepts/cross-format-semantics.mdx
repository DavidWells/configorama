...
See [the conformance guide](/guides/use-in-ci), [variable sources](/reference/variable-sources), and [filters and functions](/reference/filters-functions) for practical implications.
