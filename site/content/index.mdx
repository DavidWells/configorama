...
The main paths through these docs are [the first config guide](/guides/first-config), [inspect config](/guides/inspect-config), [the CLI reference](/reference/cli), and [the API reference](/reference/api). Read [the architecture concept](/concepts/architecture) when you want the mental model behind the commands.
