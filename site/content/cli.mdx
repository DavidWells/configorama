...
The CLI uses Configorama's configured variable syntax. If `${...}` belongs to another platform in your project, set a custom syntax in the API layer and read [bring your own syntax](/guides/bring-your-own-syntax) for wrapper examples.
...
See [structured error codes](/schemas/error-codes) and [safe inspection](/guides/inspect-config#audit-risk).
