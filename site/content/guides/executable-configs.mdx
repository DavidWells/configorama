...
If the dynamic part is just a config-time decision, use [eval variables](/variables/eval) instead. `eval(...)` handles comparisons, arithmetic, boolean checks, and ternaries without loading executable code.
