...
For deeper inspection, read [requirements mode](/guides/inspect-requirements), [error codes](/reference/error-codes), and [the resolution model](/concepts/resolution-model). If the failing value is a JS or TS file ref, start with [safe inspection](/guides/safe-inspection).
