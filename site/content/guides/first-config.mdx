...
For task-oriented next steps, read [debug resolution](/guides/inspect-config#debug-resolution) and [use Configorama in CI](/guides/use-in-ci). For the source vocabulary, see [variable sources](/variable-sources).
