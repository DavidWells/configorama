...
For task-oriented next steps, read [debug resolution](/guides/debug-resolution) and [use Configorama in CI](/guides/use-in-ci). For the source vocabulary, see [variable sources](/reference/variable-sources).
