...
See [structured error codes](/schemas/error-codes) for automation branching, [safe inspection](/guides/inspect-config#audit-risk) for trust policy, and [requirements schema](/schemas/requirements) for artifact fields.
