...
See [structured error codes](/reference/error-codes) for automation branching, [safe inspection](/guides/inspect-config#audit-risk) for trust policy, and [requirements schema](/reference/requirements-schema) for artifact fields.
